...
class BranchControllerTest {
    ...
    private static final String branchDtoJson = TestsUtils.toJson(TEST_BRANCH_DTO);

    private static final String listBranchDtoJson = TestsUtils.toJson(TEST_LIST_BRANCHES);
